...
- `auto_assign_reviewers` (String) If set, the strategy used to automatically assign reviewers to CRs targeted by this policy. Valid values: all, equal, never (default)
