...
func resourceIntegrationMemberGroup() *schema.Resource {
	builder := ResourceIntegrationMemberBuilder{
		MemberType: "group",
...
func resourceIntegrationMemberServiceAccount() *schema.Resource {
	builder := ResourceIntegrationMemberBuilder{
...
func resourceIntegrationMemberUser() *schema.Resource {
	builder := ResourceIntegrationMemberBuilder{
